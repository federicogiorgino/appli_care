...
import { JobCompanySize } from '@prisma/client'
...
function EditCompanyForm() {
  ...
  const { closeDialog, company } = useEditCompanyDialog()
  const companyId = company ? company.id : ''
  const form = useForm<CompanyValues>({
    resolver: zodResolver(companySchema),
    defaultValues: company as CompanyValues,
  })

  const mutation = useMutation({
    mutationFn: (data: CompanyValues) => updateCompany(data, companyId),
    onSuccess: (data) => {
